...
const ListLeadArchived = () => {
    ...
    return (
        <>
            <section className={styles.haut}><h1><ArchiveOutlinedIcon fontSize='large' /> Liste des leads archivés</h1> <p>{nbLeads} leads</p></section>
            {isLoading ? (
...
export default ListLeadArchived